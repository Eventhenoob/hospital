                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link to="/for-doctors" className="hover:text-gray-400">For Doctors</Link></li>
                            <li><Link to="/security" className="hover:text-gray-400">Security</Link></li>
                    ...
                    <div>
                        ...
                        <p className="mb-2">Email: <a href="mailto:contact@[appname].com" className="hover:text-gray-400">contact@[appname].com</a></p>
                        <p>Phone: <a href="tel:+1-XXX-XXX-XXXX" className="hover:text-gray-400">+1-XXX-XXX-XXXX</a></p>
                    </div>
