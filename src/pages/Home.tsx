...
const doctorFeatures = [
  {
    ...
    description: 'Easily upload and manage patient records, ensuring all information is up-to-date and accessible.',
  },
  {
    title: 'Send Prescriptions and Test Results Instantly',
    description: 'Send prescriptions and test results directly to patients in real-time, streamlining communication.',
  },
  {
    title: 'Schedule and Manage Appointments',
    description: 'Efficiently schedule and manage patient appointments with built-in reminders and notifications.',
  },
  {
    title: 'Secure Messaging and Video Consultations',
    description: 'Engage with patients securely through messaging and video consultations, ensuring privacy and convenience.',
  },
];
...
const features: Feature[] = [
  {
    ...
    description: "All your medical records, tests, prescriptions, and doctor’s notes in one secure place.",
  },
  {
    title: 'Real-Time Updates',
    description: "Doctors update your records after every visit, so you always have the latest information at your fingertips.",
  },
  {
    title: 'Secure Data Sharing',
    description: "Share your records with specialists or new healthcare providers securely and with full control.",
  },
  {
    title: 'Appointment Management',
    description: "Easily schedule, track, and get reminders for upcoming doctor appointments.",
  },
  {
    title: 'Health Analytics',
    description: "Track health trends and gain insights from your medical data over time.",
  },
  {
    title: 'Multi-Language Support',
    description: "Access your health information in multiple languages for easier understanding and communication.",
  },
];
...
const securityPoints = [
  {
    ...
    description: 'Our platform meets all relevant regional data protection standards to ensure your data is handled with the utmost care.',
  },
  {
    title: 'Two-Factor Authentication (2FA)',
    description: 'Add an extra layer of security to your account with Two-Factor Authentication (2FA).',
  },
  {
    title: 'Encrypted Data Storage',
    description: 'All data is securely encrypted both at rest and in transit, ensuring your information is protected from unauthorized access.',
  },
  {
    title: 'Full Control Over Access',
    description: 'You have complete control over who can access your information, providing peace of mind and transparency.',
  },
];
...
const steps: Step[] = [
  {
    title: 'Sign Up',
    description: 'Create your secure account and input your basic information.',
  },
  {
    title: 'Connect with Your Doctor',
    description: 'Your doctor uploads your medical records, test results, and prescriptions after each visit.',
  },
  {
    title: 'Access & Share',
    description: 'View and share your records whenever and wherever you need them.',
  },
  {
    title: 'Stay Informed',
    description: 'Receive alerts for upcoming appointments, prescription refills, and important health updates.',
  },
];
  ...
  return (
    <>
      <main className="container mx-auto mt-12 px-4">
        <section className="flex flex-col md:flex-row gap-4 overflow-hidden bg-gradient-to-r from-orange-400 to-orange-500 opacity-100 rounded-lg p-12 text-white">

          <div className="w-full md:w-2/4 flex mt-40  md:mt-10 justify-center items-center rounded-full relative">
            <div className="md:w-[30rem]  hidden md:block rounded-full w-80 h-80 md:-left-40 md:-top-24 md:rotate-45 md:rounded-r-full md:absolute z-20 bg-white"></div>
            <img src="/heroMain.png" alt="" className=" bg-white rounded-full z-30 w-80 h-80 absolute md:left-0 md:right-0 " />
          </div>
          <div className=" text-center md:text-justify md:mt-0 mt-36 flex md:pl-10 flex-col items-center">
            <div className="flex justify-center mb-6">
              <p className="text-6xl font-main font-bold">Saatvik</p>
            </div>
            <div className="">
              ...
              <p className="text-xl font-medium mb-6">
                "Saatvik is a secure platform designed to streamline the management of a person's medical history using their Aadhar card. With easy access for doctors, it ensures that healthcare professionals can quickly retrieve and review a patient's treatment records, enhancing the continuity of care across medical facilities."
              </p>
              <p className="text-lg">- Hon'ble PM Narendra Modi</p>
            </div>
          </div>
        </section>
        ...
        <section className="mt-12 flex  p-10 justify-center items-center  rounded-xl gap-10 bg-gray-800 text-white font-main font-bold  ">
          <p className="text-2xl md:text-4xl">Forget managing records—just sign in for seamless healthcare tracking</p>
          <button className="px-4 py-2 min-w-fit md:px-8 md:py-4 hover:bg-orange-600 bg-orange-500 text-white  rounded-full">Sign in</button>
        </section>
          ...
          <section className="py-20 mt-12 bg-orange-500 rounded-xl">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center">
                <h2 className="text-3xl font-extrabold text-white">Why Choose Saatvik?</h2>
                <p className="mt-4 text-lg text-slate-50">
                  Simplify your healthcare journey with these essential features.
                </p>
              </div>
              <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-4 text-black">{feature.description}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="max-w-screen-xl mx-auto px-6 lg:px-8">
              ...
              <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                {steps.map((step, index) => (
                  ...
                  >
                    <h3 className="text-xl font-semibold text-black">{`Step ${index + 1}: ${step.title}`}</h3>
        ...
        }
        {
          <section className="py-12 bg-orange-500 rounded-xl">
            <div className="max-w-screen-xl mx-auto px-6 lg:px-8">
              <div className="text-center">
                <h2 className="text-3xl font-extrabold text-white sm:text-4xl">A Seamless Experience for Doctors</h2>
                <p className="mt-4 text-lg text-white">
                  Streamline patient care with secure access to medical records and easy-to-use communication tools.
                </p>
              </div>
        ...
        }
        {
          <section className="py-12 mt-12 bg-gray-800 rounded-xl">
            <div className="max-w-screen-xl mx-auto px-6 lg:px-8">
              <div className="text-center">
                <h2 className="text-3xl font-extrabold text-white sm:text-4xl">Your Data, Safe and Secure</h2>
                <p className="mt-4 text-lg text-white">
          ...
          <section className="py-12 mb-12 bg-gray-800 mt-12 text-white">
            <div className="max-w-screen-xl mx-auto px-6 lg:px-8 text-center">
              ...
              <p className="mt-4 text-lg">
                Sign up now and take control of your medical history today.
              </p>
